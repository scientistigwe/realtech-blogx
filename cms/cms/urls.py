...
from .views import (
    CustomUserViewSet, CategoryViewSet, TagViewSet, PostViewSet,
    CommentViewSet, NotificationViewSet, RegisterView, LogoutView,
   PasswordChangeViewSet, PasswordResetConfirmViewSet, PasswordResetViewSet, AccountViewSet
    )
...
router.register(r'delete-account', AccountViewSet, basename='delete-account')
